...
class MobileBulkDisbursementScreen extends StatefulWidget {
  const MobileBulkDisbursementScreen({super.key});

  @override
  State<MobileBulkDisbursementScreen> createState() =>
      _MobileBulkDisbursementScreenState();
}

class _MobileBulkDisbursementScreenState
    extends State<MobileBulkDisbursementScreen> {
                  ...
                  ..._allVillas.map((villa) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            isSelected
                                ? const Color(0xFF9DC183).withOpacity(0.1)
                                : Colors.white,
                        border: Border.all(
                          color:
                              isSelected
                      ...
                      child: CheckboxListTile(
                        ...
                        value: isSelected,
                        onChanged:
                            (_) => _toggleVillaSelection(villa.villaNumber),
