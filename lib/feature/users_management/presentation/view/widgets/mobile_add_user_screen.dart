...
class MobileAddUserScreen extends StatefulWidget {
  const MobileAddUserScreen({super.key});

  @override
  State<MobileAddUserScreen> createState() => _MobileAddUserScreenState();
}

class _MobileAddUserScreenState extends State<MobileAddUserScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<UsersManagementCubit, UsersManagementState>(
