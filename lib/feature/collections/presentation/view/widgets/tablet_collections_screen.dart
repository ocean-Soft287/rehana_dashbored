...
class TabletCollectionsScreen extends StatefulWidget {
  const TabletCollectionsScreen({super.key});

  @override
  State<TabletCollectionsScreen> createState() =>
      _TabletCollectionsScreenState();
}

class _TabletCollectionsScreenState extends State<TabletCollectionsScreen> {
      ...
      listener: (context, state) {
        if (state is CollectionsSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('تم إضافة المقبوض بنجاح'),
